...
public class KafkaConfigProducer {
    ...
    NewTopic salesReportsEventsTopic(
            @Value("${spring.kafka.producer.sales_reports-created-events.name}") String topicName,
            @Value("${spring.kafka.producer.sales_reports-created-events.partitions}") int partitions,
            @Value("${spring.kafka.producer.sales_reports-created-events.replication-factor}") int replicationFactor,
            @Value("${spring.kafka.producer.sales_reports-created-events.min-insync-replicas}") int minInsyncReplicas) {
